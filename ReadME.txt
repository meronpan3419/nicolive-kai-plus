...
非力なパソコンでも配信できるツールなのですが、追加機能があるのでどうなのでしょうか。
...
-InternetExplorer7以降(ieframe.dllが必要なのでIE6以前は利用不可)
-OS Windows XP SP3以降
